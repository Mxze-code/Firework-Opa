...
// Simple client-side auth screen; in a production app you would
// typically use server components + cookies to guard routes.
    ...
    <div className="flex min-h-screen items-center justify-center">
      <div className="w-full max-w-md rounded-2xl border border-border/70 bg-black/40 p-6 shadow-soft backdrop-blur-xl">
        <div className="mb-6 space-y-1 text-center">
          <h1 className="text-lg font-semibold tracking-tight">Anmelden bei LifeFlow</h1>
          <p className="text-xs text-muted-foreground">
            Dein persönliches Life-Dashboard wartet bereits auf dich.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <Button
            ...
            disabled={isPending}
          >
            {isPending ? "Wird angemeldet..." : "Einloggen"}
          </Button>
        </form>
