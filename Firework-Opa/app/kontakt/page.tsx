          ...
          <div className="mx-auto w-full max-w-[1040px] h-full">
            <div className="flex h-full flex-col rounded border border-[#2d3a4d] bg-[#0f1419]/35 p-6 md:p-10">
              ...
              <div className="mt-6 flex items-stretch gap-12">
                <div className="relative w-[250px] sm:w-[270px] md:w-[320px] flex-shrink-0 overflow-hidden rounded border border-[#2d3a4d] bg-[#0f1419]/55">
                  <Image
                ...
                <p className="flex-1 text-base sm:text-lg md:text-xl leading-8 md:leading-9 text-[#94a3b8]">
